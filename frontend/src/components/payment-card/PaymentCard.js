...
export default function PaymentCard() {
    ...
    return (
        ...
        <div className="payment__info">
            ...
            <input disabled={loading} value={loading ? "Transaction in Progress...." :"Proceed"} className='btn' id='payment'  type="submit" />
        ...
        <div className="order__info">
            ...
            <ul>
                ...
                <li>
                    Plan Price
                    <span>
                    &#8377;  {state && state.period  == "month" ? state.planInfo["Monthly-Price"] : state.planInfo["Yearly-Price"]}
                    </span>
                </li>
                <hr></hr>
            </ul>
